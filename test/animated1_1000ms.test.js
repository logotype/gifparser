...
describe('should parse a GIF animation from an ArrayBuffer (1000ms)', () => {
    let gifParser = null;
    let gif = null;

    beforeEach(() => {
        gifParser = new GIFParser();
        return readFile(path.join(__dirname, '/../samples/animated1_1000ms.gif'))
            .then((arrayBuffer) => {
